...
<%
    ...
    try {
        ...
        AddFeaturedProductRequest addFeaturedProductRequest = new AddFeaturedProductRequest();
        ...
        addFeaturedProductRequest.setfeaturedproducts(featuredProducts);
        featuredProductsBean.AddFeaturedProduct(addFeaturedProductRequest);
    }
    catch (Exception ex) {
        ex.printStackTrace();
            ...
            <tr>
                ...
                <td vAlign="top">
                    <table border="0" width="600">
                        ...
                        <tr>
                            <td class="producttitle">Add Featured Product Result</td>
                        </tr>
                        <tr>
                            <td><br /></td>
                        </tr>
                        <tr>
                            <td>The featured product was added successfully.</td>
                        </tr>
                    </table>
                </td>
            </tr>
