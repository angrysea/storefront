...
<%
    ...
    try {
        ...
        addCouponRequest.setcoupon(coupon);
        couponBean.AddCoupon(addCouponRequest);
    }
    catch (Exception ex) {
        ex.printStackTrace();
            ...
            <tr>
                ...
                <td vAlign="top">
                    <table id="headingTable" border="0">
                        ...
                        <tr>
                            <td class="producttitle">Add Coupon Result</td>
                        </tr>
                    </table>
                    <br>
                    <TABLE cellSpacing="1" cellPadding="3" width="95%" border="0">
                    <tr>
                        <td noWrap>The coupon [<%=request.getParameter("code")%>] was added successfully.</td>
                    </tr>
                    </TABLE>
                    <br>
                </td>
