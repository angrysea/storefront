            ...
            <tr>
                ...
                <td vAlign="top">
                    <table id="headingTable" height="100%" border="0">
                        ...
                        <tr>
                            <td class="producttitle">Most Popular Products</td>
                        </tr>
                    </table>
                    ...
                    <TABLE cellSpacing="1" cellPadding="3" width="750" border="0">
                        ...
                        %>
                                <TR>
                                    ...
                                    <TD align="left" valign="top"><a href="./productupdate.jsp?id=<%=new Integer(item.getid()).toString()%>"><%=new Integer(item.getid()).toString()%></a></TD>
