            ...
            <tr>
                ...
                <td vAlign="top">
                    <table id="headingTable" height="100%" border="0">
                        ...
                        <tr>
                            <td class="producttitle">Products</td>
                        </tr>
                    </table>
                    <form name="form1" action="./products.jsp" method="GET">
                    <table>
                        <tr>
                    ...
                    <TABLE cellSpacing="1" cellPadding="3" width="750" border="0">
                        <TR>
                            ...
                            <TD class="columnheader" align="right"><b>Quantity</b></TD>
                            <TD class="columnheader" align="right"><b>List Price</b></TD>
                            <TD class="columnheader" align="right"><b>Our Cost</b></TD>
                        ...
                        %>
                                <TR>
                                    <TD noWrap align="left"><a href="./productupdate.jsp?id=<%=new Integer(item.getid()).toString()%>&manufacturer=<%=request.getParameter("manufacturer")%>"><%=new Integer(item.getid()).toString()%></a></TD>
                                    ...
                                    <TD noWrap align="right"><%=new Integer(item.getquantity()).toString()%></TD>
                    ...
                    <table border="0">
                        <tr>
                            <td class="smallprompt"><A href="./productadd.jsp">Add a new Product</A></td>
                        </tr>
                    </table>
                </td>
            </tr>
