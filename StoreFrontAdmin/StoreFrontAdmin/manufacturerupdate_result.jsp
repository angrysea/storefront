...
<%
    try {
        ...
        manufacturer.setid(new Integer(request.getParameter("manufacturerid")).intValue());
        ...
        UpdateManufacturerRequest updateManufacturerRequest = new UpdateManufacturerRequest();
        updateManufacturerRequest.setmanufacturer(manufacturer);

        lists.UpdateManufacturer(updateManufacturerRequest);
    }
    catch (Exception ex) {
        ex.printStackTrace();
            ...
            <tr>
                ...
                <td vAlign="top">
                    <table id="headingTable" border="0">
                        ...
                        <tr>
                            <td class="producttitle">Update Manufacturer Result</td>
                        </tr>
                    </table>
                    <br>
                    <TABLE cellSpacing="1" cellPadding="3" width="95%" border="0">
                    <tr>
                        <td noWrap>The manufacturer [<%=request.getParameter("name")%>] was updated successfully.</td>
                    </tr>
                    </TABLE>
                    <br>
                    <TABLE border="0">
