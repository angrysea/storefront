...
<%
    ...
    try {
        ...
        getItemRankingResponse = itemRankingBean.GetItemRankingSales(getItemRankingRequest);
    }
    catch (Exception ex) {
        ex.printStackTrace();
        throw new ServletException(ex.getMessage());
            ...
            <tr>
                ...
                <td vAlign="top">
                    <table id="headingTable" height="100%" border="0">
                        ...
                        <tr>
                            <td class="producttitle">Most Purchased Products</td>
                        </tr>
                    </table>
                    <form name="form1" action="./report_mostpurchasedproducts.jsp" method="GET" onsubmit="return(OnSubmitForm())">
                    <table>
                        <tr>
                    ...
                    <TABLE cellSpacing="1" cellPadding="3" width="750" border="0">
                        <TR>
                            ...
                            <TD class="columnheader" align="right"><b>Number of Purchases</b></TD>
                        </TR>
                        <tr>
                            <td colspan="10">
