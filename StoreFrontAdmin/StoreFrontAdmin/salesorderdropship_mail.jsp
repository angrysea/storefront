...
<%
    ...
    try {
        ...
        getSalesOrderRequest.setid(new Integer(request.getParameter("salesorderid")).intValue());
            ...
            <tr>
                ...
                <td vAlign="top">
                    <table border="0">
                        ...
                        <tr bgcolor="<%=theme.getcolor2()%>">
                            <td nowrap class="producttitle" width="550">Drop Ship Order</td>
                        </tr>
                    </table>
                    <table border="0" cellpadding="0" cellspacing="0" width="550">
                        <tr>
                            <td><b>Sales Order Number:</b> <%=new Integer(salesOrder.getid()).toString()%></td>
                        </tr>
                        <tr>
                            <td><br></td>
                        </tr>
                ...
                %>
                    ...
                    <table border="0" width="550">
                        ...
                        <tr>
                            <td valign="top">
                                <table border="0" cellSpacing="0" cellPadding="0">
                                <tr>
                                    <td nowrap><b>Shipping Method</b></td>
                                </tr>
                                <tr>
                                    <td nowrap><%=salesOrder.getshippingmethod().getcarrier()%></td>
                                </tr>
                                <tr>
                                    <td nowrap><%=salesOrder.getshippingmethod().getdescription()%></td>
                                </tr>
                                </table>
                            </td>
                        </tr>
                    ...
                    <table border="0" width="550">
                        ...
                        <tr>
                            <td>Please send an e-mail to <a href="mailto:<%=company.getemail1()%>"><%=company.getemail1()%></a> when this order ships.  Also, please include the <b>tracking number</b> and the <b>sales order number</b> (listed above) in the e-mail. Please do not include any promotional information in the box for shipment to the customer.  Also, please do not include any pricing information on the packing slip.</td>
                        </tr>
                        <tr>
                            <td><br></td>
                        </tr>
