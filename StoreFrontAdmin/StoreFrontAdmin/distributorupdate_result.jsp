...
<%
    try {
        ...
        distributor.setid(new Integer(request.getParameter("distributorid")).intValue());
        ...
        updateDistributorRequest.setdistributor(distributor);

        lists.UpdateDistributor(updateDistributorRequest);
    }
    catch (Exception ex) {
        ex.printStackTrace();
            ...
            <tr>
                ...
                <td vAlign="top">
                    <table id="headingTable" border="0">
                        ...
                        <tr>
                            <td class="producttitle">Update Distributor Result</td>
                        </tr>
                    </table>
                    <br>
                    <TABLE cellSpacing="1" cellPadding="3" width="95%" border="0">
                    <tr>
                        <td noWrap>The distributor [<%=request.getParameter("name")%>] was updated successfully.</td>
                    </tr>
                    </TABLE>
                    <br>
                </td>
