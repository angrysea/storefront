...
public class PriceGrabberFeed extends BaseBean {
  ...
  private static String categorization = "Categorization";
  ...
  private static final short colproduct_name = 0;
  private static final short colmanufacturer = 1;
  private static final short colmpn = 2;
  private static final short colcategorization = 3;
  private static final short colproduct_description = 4;
  private static final short colproduct_price = 5;
  private static final short colstock_availability = 6;
  private static final short colproduct_url = 7;
  private static final short colimage_url = 8;
  private static final short colstock_description = 9;
  private static final short colweight = 10;
  ...
  public PriceGrabberFeed() throws ServletException {
    super();
    this.localpath="c:\\feed\\pricegrabber\\";
  }

  public PriceGrabberFeed(String localpath) throws ServletException {
    super();
      ...
      for (int i = 1; i < last; i++) {
        ...
        for (short col=0; col<10; col++) {
          if ( (cell = row.getCell(col)) != null) {
            switch (col) {
              case colproduct_name:
              case colmanufacturer:
              case colmpn:
              case colcategorization:
              case colproduct_description:
              case colstock_availability:
              case colproduct_url:
              case colimage_url:
              case colstock_description:
                buffer.append(cell.getStringCellValue());
                buffer.append(",");
                break;

              case colproduct_price:
  ...
  public void GenerateFeedFile() throws Exception {
    ...
    try {
      ...
      HSSFSheet sheet = wb.createSheet("pricegrabber feed");
      ...
      DataFeed datafeed = GetDataFeed(conn, "pricegrabber");
  ...
  public static void main(String args[]) {
    ...
    try {
      PriceGrabberFeed pricegrabberfeed = new PriceGrabberFeed("/feed/pricegrabber/");
      pricegrabberfeed.GenerateFeedFile();
    }
    catch (Exception e) {
    }
  }
