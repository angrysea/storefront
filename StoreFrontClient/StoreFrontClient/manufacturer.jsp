...
<%
    ...
    GetManufacturerResponse getManufacturerResponse = null;
    ...
    try {
        ...
        searchRequest.setmanufacturerid(request.getParameter("id"));
        ...
        <table cellSpacing="0" cellPadding="0" border="0">
            <tr>
                ...
                <td vAlign="top">
                    ...
                    <table border="0">
                        <tr>
                            <td><img alt="<%=getManufacturerResponse.getmanufacturer().getlongname()%>" src="<%=getManufacturerResponse.getmanufacturer().geturl()%>"/></td>
                        </tr>
                    </table>
                    ...
                    <table border="0" width="775">
                        <tr>
                            <td nowrap colspan="2"><b>Our Most Popular:</b> <%=getManufacturerResponse.getmanufacturer().getlongname()%></td>
                        </tr>
                    </table>
                        ...
                        <tr>
                            <td colspan="20">
                                <table border="0" cellspacing="0" cellpadding="0" width="775">
                                    <tr>
                                        <td align="right">
                                           <a href="<%=StoreFrontUrls.getsearchresults(request, company, getManufacturerResponse.getmanufacturer().getname(), "0", "0", "0", Integer.toString(getManufacturerResponse.getmanufacturer().getid()), "0", "0", "1")%>"><font color="red">More <%=getManufacturerResponse.getmanufacturer().getlongname()%> >></font></a>
                                        </td>
                                    </tr>
                                </table>
                            </td>
